...
#
# Begin "charset_Release" configuration
#

ifeq ($(MAKECMDGOALS),charset_Release)

charset_Release : ./Release/charset.dxe 
...
./Release/charset.dxe :./stud1.ldf ./Release/stud1_capi.doj ./Release/stud1_init.doj ./Release/stud1_isr.doj ./Release/stud1_lcd.doj ./Release/stud1_main.doj ./Release/stud1_proc.doj ./Release/stud1_re.doj ./Release/stud1_user_app.doj $(ADI_DSP_MAKE)/219x/lib/libio.dlb $(ADI_DSP_MAKE)/219x/lib/libc.dlb $(ADI_DSP_MAKE)/219x/lib/libdsp.dlb $(ADI_DSP_MAKE)/219x/lib/libetsi.dlb 
	$(VDSP)/cc219x.exe .\Release\stud1_capi.doj .\Release\stud1_init.doj .\Release\stud1_isr.doj .\Release\stud1_lcd.doj .\Release\stud1_main.doj .\Release\stud1_proc.doj .\Release\stud1_re.doj .\Release\stud1_user_app.doj -T .\stud1.ldf -L .\Release -flags-link -od,.\Release -o .\Release\charset.dxe -proc ADSP-2191 -flags-link -MM
	elfloader .\Release\charset.dxe -b SPI -f BINARY -width 8 -proc ADSP-2191 -o .\Release\charset.bin

endif

ifeq ($(MAKECMDGOALS),charset_Release_clean)
